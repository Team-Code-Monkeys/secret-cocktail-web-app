        ...
        <div className={styles.container}>
            <Navbar/>
            {
                ...
                <div className={styles.innerContainer}>
                    ...
                    <textarea value={report} onChange={(event) => {setReport(event.target.value)}} className={styles.textArea} placeholder={'Leave your message'}></textarea>
                    <div className={styles.btnOuterContainer}>
                        <div className={styles.btnContainer}>
                            ...
                            }} style={{background: '#50C878', borderColor: '#50C878'}}>Send Message</button>
                        </div>
                    </div>
                </div>
            }
