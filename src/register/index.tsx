        ...
        <div className={styles.container}>
            ...
            <div className={styles.formContainer}>
                <div className={styles.inputContainer}>
                    <input
                        placeholder="Email" type="email" className={styles.input} value={email}
                ...
                <div className={styles.inputContainer}>
                    <input
                      placeholder="Password" type="password" className={styles.input} value={password}
                ...
                <div className={styles.inputContainer}>
                    <input
                      placeholder="Confirm Password" type="password" className={styles.input}
