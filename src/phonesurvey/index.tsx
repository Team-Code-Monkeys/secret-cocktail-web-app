            ...
            <div className={styles.listItemContainer} key={question.id}>
              ...
              <div className={styles.listItemButtonsContainer}>
                <button
                  ...
                  onClick={() => {
                    deleteDoc(doc(db, "question", question.id || ""))
                      .then(() => {
          ...
          <Modal.Footer>
            <Button
              ...
              onClick={() => {
                const phoneRef = doc(
                  db,
                  "to-contact-for-survey",
                  hashCode(facilityPhoneNumber).toString() +
                    Math.round(new Date().getTime()).toString()
                );
                setDoc(
                  phoneRef,
...
function Waves() {
  return <img src={wave} className="wave" alt={"Wave for styling webpage."} />;
}
